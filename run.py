...
if __name__ == "__main__":
    ...
    # check some simple things to make sure file is formatted correctly
    ...
    try:
        CONF.SPECIES = app.config['SPECIES']
        ...
        CONF.WWW_EFFECT_SHOW = app.config['WWW_EFFECT_SHOW']
        ...
        CONF.WWW_FACT_SHOW = app.config['WWW_FACT_SHOW']
        ...
        CONF.WWW_FACT_ORDER = app.config['WWW_FACT_ORDER']
        CONF.MATRIX_FEATURE_ID_TEXT = app.config['MATRIX_FEATURE_ID_TEXT']
        CONF.MATRIX_FEATURE_LOCATION_TEXT = app.config['MATRIX_FEATURE_LOCATION_TEXT']
        CONF.MATRIX_FEATURE_NAME_TEXT = app.config['MATRIX_FEATURE_NAME_TEXT']
        CONF.MATRIX_MARKER_ID_TEXT = app.config['MATRIX_MARKER_ID_TEXT']
        CONF.MATRIX_MARKER_LOCATION_TEXT = app.config['MATRIX_MARKER_LOCATION_TEXT']
        CONF.MATRIX_MARKER_NAME_TEXT = app.config['MATRIX_MARKER_NAME_TEXT']
        CONF.MATRIX_SCORE_TEXT = app.config['MATRIX_SCORE_TEXT']
        CONF.DATA_USE_GROUP_ID = app.config['DATA_USE_GROUP_ID']
        CONF.MATRIX_FEATURE_GROUP_ID_TEXT = app.config['MATRIX_FEATURE_GROUP_ID_TEXT']
    except KeyError, ke:
        print '{} entry not found in config file'.format(ke)
